...
export const styles = sortCx({
    common: {
        root: [
            "group relative inline-flex h-max cursor-pointer items-center justify-center whitespace-nowrap transition duration-100 ease-linear focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring",
    ...
    colors: {
        primary: {
            root: [
                "bg-primary text-primary-foreground shadow-xs ring-1 ring-transparent ring-inset hover:bg-primary/90 data-loading:bg-primary/90",
                "*:data-icon:text-primary-foreground/80 hover:*:data-icon:text-primary-foreground",
            ].join(" "),
        },
        secondary: {
            root: [
                "border border-input bg-background text-foreground shadow-xs ring-0 hover:bg-muted data-loading:bg-muted",
